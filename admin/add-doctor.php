    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form method = "POST" action="newdoctor.php">
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"id = "identitycard" name = "identitycard" type="text">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type ="text" class="form-control" name="specialize" id = "specialize"> 
                                    </div>
                                </div>
                                <div class="col-sm-6">
									<div class="form-group">
                            ...
                            <div class="m-t-20 text-center">
                                <input type="submit" name = "submit" value="submit">Create Doctor</input></td>
                                <a href="newdoctor.php"><button type="button">Back</button></a></td>
                            </div>
                        </form>
                    </div>
                </div>
