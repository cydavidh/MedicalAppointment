    ...
    <div class="main-wrapper">
        <div class="header">
            <div class="header-left">
                <a href="schedule.php" class="logo">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped custom-table">
                                ...
                                <tbody>
                                    <?php
                                    include("config.php");
                                    $sql = "SELECT appointment_ID, date_time, Doctor, patientname, identitycard  FROM appointment as ap
                                        JOIN patient as pa on pa.identitycard = ap.identitycard_FK";
                                    ...
                                    if ($result = $link->query($sql)) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo '<td> <a type="button" class="btn btn-light" href="deleteAppointment.php?appointment_ID='.$row["appointment_ID"].'">X</a> </td>';
                                            echo '<td class="text-right"> <a type="button" class="btn btn-light" href="medical-record.php?patientname='.$row["patientname"].'">></a> </td>';
                                            '</tr>';
                                        }
                                        $result->free();
                                    }
