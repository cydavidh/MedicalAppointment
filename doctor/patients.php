        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    ...
                    <!--                        <a href="add-employee.html" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Patients</a>-->
                    <!--                    </div>-->
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped custom-table">
                                ...
                                <tbody>
                                    <?php
                                    include("config.php");
                                    $sql = "SELECT patientid, patientname, date, age, gender, identitycard  FROM patient";
